package com.barberia.employedservice.infrastructure.entrypoint.reativeweb.exceptions;
...
public enum TechnicalExceptionsMessage {
    ...
    EXTERNAL_UNKNOWN(HttpStatus.INTERNAL_SERVER_ERROR, "997", "external unknown error"),
